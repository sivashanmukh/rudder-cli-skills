...
Ground-truth reference for marketplace/plugin/skill structure: [`skills.md`](../../../../skills.md).
...
│   └── superpowers/specs/
│       └── 2026-04-20-rudder-agent-skills-marketplace-reorg-design.md
...
1. **Add reorg design spec** — write `docs/superpowers/specs/2026-04-20-rudder-agent-skills-marketplace-reorg-design.md` (this document) to `main` so it's the first artifact of the reorganization.
